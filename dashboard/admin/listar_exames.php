...
<head>
    ...
    <style>
        ...
        nav a { margin-right: 15px; text-decoration: none; color: #2b6cb0; }
    </style>
</head>
...
<tr>
    ...
    <td>
        <a class="btn-editar" href="editar_exame.php?id=<?= $linha['id']; ?>">Editar</a>
        <a class="btn-excluir" 
           href="excluir_exame.php?id=<?= $linha['id']; ?>" 
           onclick="return confirm('Tem certeza que deseja excluir este exame?');">Excluir</a>
    </td>
</tr>
<?php endwhile; ?>
