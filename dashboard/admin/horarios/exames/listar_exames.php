...
// Buscar exames
$sql = "SELECT * FROM exames ORDER BY data, hora_inicio";
...
<main class="container">
    ...
    <div class="page-actions">
        <a href="criar_exame.php" class="btn btn-primary">
    ...
    <?php if ($total === 0): ?>
        <div class="empty-state">
            ...
            <p>Não há exames disponíveis no momento.</p>
            <a href="criar_exame.php" class="btn btn-primary" style="margin-top: 1rem;">
                <i class="fas fa-plus-circle"></i>
    ...
    <?php else: ?>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="data-badge badge-data">
                                <i class="fas fa-calendar"></i>
                                <?= !empty($linha['data']) ? date('d-m-Y', strtotime($linha['data'])) : '-'; ?>
                            </span>
                        </td>
                        <td>
                        ...
                        <td>
                            <span class="data-badge badge-duracao">
                                <i class="fas fa-hourglass-half"></i>
                                <?= htmlspecialchars($linha['duracao']); ?>
                            </span>
                        </td>
                        <td>
                            <div class="action-buttons">
                                <a href="editar_exame.php?id=<?= $linha['id']; ?>" class="btn btn-editar">
                                    <i class="fas fa-edit"></i>
                                    Editar
                                </a>
                                <a href="excluir_exame.php?id=<?= $linha['id']; ?>" 
        ...
        <div class="alert alert-info">
            ...
            Exibindo <strong><?= $total ?></strong> exame(s) cadastrado(s) no sistema.
        </div>
    <?php endif; ?>
</main>
