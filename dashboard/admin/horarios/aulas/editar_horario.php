...
<main class="container">
    ...
    <div class="breadcrumb">
        ...
        <span class="separator">/</span>
        <a href="../index.php">Horários</a>
        <span class="separator">/</span>
        <a href="listar_horarios.php">Listar Horários</a>
        <span class="separator">/</span>
        <span>Editar Horário #<?= $id ?></span>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="dia_semana" class="form-select">
                                <?php foreach ($diasSemana as $d): ?>
                                    <option value="<?= $d ?>" <?= $horario['dia_semana']===$d?'selected':'' ?>>
                                        <?= $d ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="curso" class="form-select">
                                <?php foreach ($cursos as $c): ?>
                                    <option value="<?= $c ?>" <?= $horario['curso']===$c?'selected':'' ?>>
                                        <?= $c ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="ano" class="form-select">
                                <?php foreach ($anos as $a): ?>
                                    <option value="<?= $a ?>" <?= $horario['ano']===$a?'selected':'' ?>>
                                        <?= $a ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="semestre" class="form-select">
                                <?php foreach ($semestres as $s): ?>
                                    <option value="<?= $s ?>" <?= $horario['semestre']===$s?'selected':'' ?>>
                                        <?= $s ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <input type="text" name="disciplina" class="form-input" 
                                   value="<?= htmlspecialchars($horario['disciplina']); ?>" required>
                        </td>
                        ...
                        <td>
                            <select name="turno" class="form-select">
                                <?php foreach ($turnos as $t): ?>
                                    <option value="<?= $t ?>" <?= $horario['turno']===$t?'selected':'' ?>>
                                        <?= $t ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="sala" class="form-select">
                                <?php foreach ($salas as $sala): ?>
                                    <option value="<?= $sala ?>" <?= $horario['sala']===$sala?'selected':'' ?>>
                                        <?= $sala ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <input type="time" name="hora_fim" class="form-input"
                                   value="<?= date('H:i', strtotime($horario['hora_fim'])); ?>" required>
                        </td>
                    </tr>
                </tbody>
            </table>
