...
<head>
    ...
    <title>Editar Teste - SMART KAMPUS</title>
...
<main class="container">
    ...
    <div class="teste-info">
        ...
        <div class="teste-details">
            <h3><?= htmlspecialchars($teste['disciplina']) ?> - <?= htmlspecialchars($teste['curso']) ?></h3>
            <p>Data: <?= date('d/m/Y', strtotime($teste['data'])) ?> • Sala: <?= htmlspecialchars($teste['sala']) ?> • Horário: <?= substr($teste['hora_inicio'], 0, 5) ?> - <?= substr($teste['hora_fim'], 0, 5) ?></p>
        </div>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="atualizar_teste.php">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="dia_semana" class="form-select">
                                <?php foreach ($diasSemana as $d): ?>
                                    <option value="<?= $d ?>" <?= $teste['dia_semana']===$d?'selected':'' ?>>
                                        <?= $d ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <input type="date" name="data" class="form-input" 
                                   value="<?= htmlspecialchars($teste['data']); ?>" required>
                        </td>
                        ...
                        <td>
                            <select name="curso" class="form-select">
                                <?php foreach ($cursos as $c): ?>
                                    <option value="<?= $c ?>" <?= $teste['curso']===$c?'selected':'' ?>>
                                        <?= $c ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="ano" class="form-select">
                                <?php foreach ($anos as $a): ?>
                                    <option value="<?= $a ?>" <?= $teste['ano']===$a?'selected':'' ?>>
                                        <?= $a ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="semestre" class="form-select">
                                <?php foreach ($semestres as $s): ?>
                                    <option value="<?= $s ?>" <?= $teste['semestre']===$s?'selected':'' ?>>
                                        <?= $s ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <input type="text" name="disciplina" class="form-input" 
                                   value="<?= htmlspecialchars($teste['disciplina']); ?>" required>
                        </td>
                        ...
                        <td>
                            <select name="turno" class="form-select">
                                <?php foreach ($turnos as $t): ?>
                                    <option value="<?= $t ?>" <?= $teste['turno']===$t?'selected':'' ?>>
                                        <?= $t ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <select name="sala" class="form-select">
                                <?php foreach ($salas as $sala): ?>
                                    <option value="<?= $sala ?>" <?= $teste['sala']===$sala?'selected':'' ?>>
                                        <?= $sala ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <td>
                            <input type="time" name="hora_inicio" class="form-input"
                                   value="<?= htmlspecialchars($teste['hora_inicio']); ?>" required>
                        </td>

                        <!-- Hora Fim -->
                        <td>
                            <input type="time" name="hora_fim" class="form-input"
                                   value="<?= htmlspecialchars($teste['hora_fim']); ?>" required>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="form-actions">
                ...
                <a href="listar_testes.php" class="btn btn-secondary">
