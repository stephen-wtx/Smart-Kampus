...
<head>
    ...
    <title>Listar Testes - SMART KAMPUS</title>
...
<main class="container">
    ...
    <div class="page-actions">
        <a href="criar_teste.php" class="btn btn-primary">
    ...
    <?php if ($total === 0): ?>
        <div class="empty-state">
            ...
            <h3>Nenhum teste cadastrado</h3>
            <p>Não há testes disponíveis no momento.</p>
            <a href="criar_teste.php" class="btn btn-primary" style="margin-top: 1rem;">
                <i class="fas fa-plus-circle"></i>
    ...
    <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="editar_teste.php?id=<?= $linha['id']; ?>" class="btn btn-editar">
                                    <i class="fas fa-edit"></i>
                                    Editar
                                </a>
                                <a href="excluir_teste.php?id=<?= $linha['id']; ?>" 
        ...
        <div class="alert alert-info">
            ...
            Exibindo <strong><?= $total ?></strong> teste(s) cadastrado(s) no sistema.
        </div>
    <?php endif; ?>
</main>
