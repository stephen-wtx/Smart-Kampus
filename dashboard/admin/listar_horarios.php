    ...
    <?php while ($linha = $resultado->fetch_assoc()): ?>
        <tr>
            ...
            <td>
                ...
                <td>
                    <a class="btn-editar" href="editar_horario.php?id=<?= $linha['id']; ?>">Editar</a>
                    <a class="btn-excluir" 
                    href="excluir_horario.php?id=<?= $linha['id']; ?>" 
                    onclick="return confirm('Tem certeza que deseja excluir este horário?');">Excluir</a>
                </td>
